...
<div class="wrapper margin0_auto">
	...
	<div class="content">
        ...
        <div class="personInfo">
            ...
            <ul class="none_list_style_type">
                <li class="f14 float_l"><a href="onlineRepairSystem/OnlineRepairServlet?action=repairPersonManage">个人报修单</a></li>
                <li class="f14 float_l"><a href="javascript:;" class="f_blue0066ff">全部报修单</a></li>
            </ul>   
            <hr/>
            <div class="dutyRegister repairsManagement">
                <div class="pn">
                <a href="javascript:;"><img src="images/dutyRegister/output.png" alt="导出" title="导出"/></a>
                <a href="onlineRepairSystem/OnlineRepairServlet?action=repairPersonManage&option=showAllRepairLists&userCurrentPage=1"><img src="images/dutyRegister/first.png" alt="第一页" title="第一页"/></a>
                <c:choose>
                  <c:when test="${sessionScope.userCurrentPage==1}">
                  	<img src="images/dutyRegister/previous.png" alt="上一页" title="上一页"/>&nbsp;&nbsp;&nbsp;
                  </c:when>
                  <c:otherwise>
                  	<a href="onlineRepairSystem/OnlineRepairServlet?action=repairPersonManage&option=showAllRepairLists&userCurrentPage=${sessionScope.userCurrentPage-1}"><img src="images/dutyRegister/previous.png" alt="上一页" title="上一页"/></a>&nbsp;&nbsp;&nbsp;
                  </c:otherwise>               
                </c:choose>
                <c:choose>
                  ...
                  <c:otherwise>
                  	<a href="onlineRepairSystem/OnlineRepairServlet?action=repairPersonManage&option=showAllRepairLists&userCurrentPage=${sessionScope.userCurrentPage+1}"><img src="images/dutyRegister/next.png" alt="下一页" title="下一页"/></a>
                  </c:otherwise>               
                </c:choose>      
                <a href="onlineRepairSystem/OnlineRepairServlet?action=repairPersonManage&option=showAllRepairLists&userCurrentPage=${sessionScope.userAllpage}"><img src="images/dutyRegister/last.png" alt="最后一页" title="最后一页"/></a>
                <span>
                ...
                <div class="right_form">
                  <form action="onlineRepairSystem/OnlineRepairServlet?action=repairPersonManage&option=showAllRepairLists" method="post">
