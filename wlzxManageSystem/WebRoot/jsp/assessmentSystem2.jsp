	...
	<div class="content" style="height:100%;">
        ...
        <div class="menu" style="height:100%;float:left">
            <ul class="none_list_style_type">
                ...
                <li><a href="TestPaperServlet?action=testPaperShow" class="active"><img alt="" src="images/assessment/online.png"/><p>在线考核</p></a></li>
                <li><a href="ExamServlet?action=examShow1&flag=mark"><img alt="" src="images/assessment/chart.png"/><p>成绩统计</p></a></li>
				<li><a href="ExamServlet?action=examShow1&flag=analyze"><img alt="" src="images/assessment/aly.png"/><p>考核分析</p></a></li>
            </ul>
        </div>
    	<!--左部菜单end-->
        ...
        <div class="personInfo">
			<div class="personInfo_nav f14">考核系统&nbsp;&nbsp;>>&nbsp;&nbsp;在线考核</div>
            <ul class="none_list_style_type">
                <li class="f14 float_l">选择试卷进行考核</li>
            </ul>
            <hr/>
			<div class="dutyRegister repairsManagement">
            	<table style="margin-top:150px;">
                	<tr class="head"><td>考卷列表</td><td>出卷时间</td><td>操作</td></tr>
                	<c:forEach var="tp" items="${testPapersList}" varStatus="status">
                    	<tr>
                    		<td>${tp.paperName}</td>
                    		<td><fmt:formatDate value="${tp.paperDate}" type="date"/></td>
                    		<td><a href="ExamServlet?action=exam&testPaperID=${tp.paperID}" target="_blank">进行考核</a></td>
                    	</tr>
                    </c:forEach>
                </table>
            </div>
