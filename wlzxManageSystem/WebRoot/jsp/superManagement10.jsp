	...
	<div class="content">
        ...
        <div class="personInfo superManagement19">
            ...
            <ul class="none_list_style_type">
                ...
                <br/>
                <span class="f14">
                    <a href="javascript:;" class="f_blue0066ff">楼栋管理 &nbsp;</a>
            ...
            <form name="superManagement9Form" method="post" action="">
                <div class="queryWage superManagement4 superManagement7 superManagement8Modal">
                    <table class="editStatus">
                        <tr><td width="500" style="width: 100px !important;">楼栋</td><td><input type="text" name="building" /></td></tr>
                        <tr><td width="500">负责人</td><td><input type="text" name="chargePerson" /></td></tr>
                    </table>
