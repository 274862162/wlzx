	...
	<div class="content" style="height:100%;">
        ...
        <div class="menu" style="height:100%;float:left">
            <ul class="none_list_style_type">
                ...
                <li><a href="ExamServlet?action=examShow1&flag=mark" class="active"><img alt="" src="images/assessment/chart.png"/><p>成绩统计</p></a></li>
        ...
        <div class="personInfo">
			<div class="personInfo_nav f14">考核系统&nbsp;&nbsp;>>&nbsp;&nbsp;成绩统计&nbsp;&nbsp;</div>
            <ul class="none_list_style_type">
                <li class="f14 float_l">选择试卷进行批改</li>
            </ul>
            <hr/>
            	...
            	<table style="margin-top:150px;">
                    ...
                    <c:forEach var="ep" items="${examinePapersList}" varStatus="status">
                    	<tr>
                    		...
                    		<td><a href="ExamServlet?action=examShow2&paperID=${ep.paperID}&paperName=${ep.paperName}">进行批改</a></td>
                    	</tr>
                    </c:forEach>
                </table>
            </div>
