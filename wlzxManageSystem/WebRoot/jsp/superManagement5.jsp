...
<head>
	...
	<script type="text/javascript">
		...
		function show(imgID){
			$("#imagesID").val(imgID);
			var param = {};
			param.imagesID = imgID;
			$.ajax({
		 	   url  : "CommonServlet_ajax?action=getImages",  
		 	   data : param,
		 	   type : "post",                  
		 	   cache: false,
		 	   dataType:"json", 
		...
		function del(imgID){
			...
			param.imagesID = imgID;
			$.ajax({
		 	   url  : "CommonServlet_ajax?action=delImages",  
		 	   data : param,
		 	   type : "post",                  
		 	   cache: false,
		 	   dataType:"text", 
	 		   ...
	 		   success :function(result){  //请求成功时调用。 
	 		   		alert(result);
					window.location.href="jsp/superManagement5.jsp";		 			 
	 		   }
 			});
		};
		//取滑动窗口图片列表
		function getImages(){
			...
			$.ajax({
	 		   url  : "CommonServlet_ajax?action=imagesShow",  
	 		   data : param,
	 		   type : "post",                  
	 		   cache: false,
	 		   dataType:"json", 
	 		   ...
	 		   success :function(result){  //请求成功时调用。 
	 		   		$("#tb_image").children($("<tr>")).remove();
	 		   		$("#tb_image").append('<tr class="head"><td>发布时间</td><td>图片</td><td>操作人</td><td>操作</td></tr>');
	 		   		$.each(result,function(){
		 			    $.each(this.list,function(){
		 			    	$("#tb_image").append('\
		 			    		...
		 			    		<td>'+this.fileName+'</td>\
		 			    		<td>'+this.operator+'</td>\
		 			    		<td><a href="javascript:del('+this.imagesID+');">删除</a>&frasl;<a href="javascript:show('+this.imagesID+');" id="modifyButton">修改</a></td></tr>');
		 			    });
...
<div class="wrapper margin0_auto" style="height:100%;">
	...
	<div class="content" style="height:100%;">
        ...
        <div class="personInfo">
            ...
            <ul class="none_list_style_type">
                ...
                <li class="f14 float_l"><a href="jsp/superManagement5.jsp" class="f_blue0066ff">滑动窗口管理</a></li>
            ...
            <div class="queryWage superManagement4 superManagement5">
                <table id="tb_image">
                    <tr class="head"><td>发布时间</td><td>图片</td><td>操作人</td><td>操作</td></tr>
                ...
                <div class="button" id="recommendedPlan-Button2"><input type="button" value="添加图文"></div>
            </div>
        </div>	
    	<!--个人信息end-->
    ...
    <div id="recommendedPlan">
        <div class="recommendedPlan-title">修改滚动图片<img src="images/surveySystem/delete.png" title="close" alt="close" class="close" id="close-button" /></div>
        <div class="f14 recommendedPlan">
            <form name="superManagement6Form" method="post" action="CommonServlet_redirect?action=updateImages" enctype="multipart/form-data">
    ...
    <div id="recommendedPlan2">
        <div class="recommendedPlan-title">增加滚动图片<img src="images/surveySystem/delete.png" title="close" alt="close" class="close" id="close-button2" /></div>
        <div class="f14 recommendedPlan">
            <form name="superManagement6Form" method="post" action="CommonServlet_redirect?action=addImages" enctype="multipart/form-data">
                <div class="queryWage superManagement4 superManagement7 superManagement8Modal">
                    <table>
