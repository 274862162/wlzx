...
public class ScheduleExportAction implements Action{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		...
		Sheet sheet = null;
		if ("free".equals(flag)) {
			sheet = wb.createSheet("无课表");  // 创建第一个Sheet页
		}else if ("duty".equals(flag)) {
		...
		if ("free".equals(flag)) {
			title[0] = new String("2014--2015学年度第二学期校园网络中心无课表");
		}else if ("duty".equals(flag)) {
			title[0] = new String("2014--2015学年度第二学期校园网络中心值班表");
		}
		String headers[] = {"课时","星期一","星期二","星期三","星期四","星期五"};  
		String[] time12 = new String[1]; //{"上午（1,2）节"};
		String[] time345 = new String[1];
		String[] time678 = new String[1];
		
		if ("free".equals(flag)) {
			time12[0] = new String("上午（1,2）节");
			time345[0] = new String("上午（3,4,5）节");
			time678[0] = new String("下午（6,7,8）节");
		}else if ("duty".equals(flag)) {
			time12[0] = new String("8:30——9:30");
			time345[0] = new String("9:35——11:30");
			time678[0] = new String("14:30——17:00");
		}
		...
		if ("free".equals(flag)) {
			fileName = "2014--2015学年度第二学期校园网络中心无课表.xls";
		}else if ("duty".equals(flag)) {
			fileName = "2014--2015学年度第二学期校园网络中心值班表.xls";
		}
