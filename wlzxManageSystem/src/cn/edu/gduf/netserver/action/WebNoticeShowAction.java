...
public class WebNoticeShowAction implements Action {
	...
	public String execute(HttpServletRequest request,
		...
		int totalNum = webNoticeDao.count();  // 公告总数
		...
		List<WebNotice> webNoticeList = webNoticeDao.getWebNotice(pageBean);
		Result result = new Result();
		result.setList(webNoticeList);
