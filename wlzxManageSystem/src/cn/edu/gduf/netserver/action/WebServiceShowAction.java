...
public class WebServiceShowAction implements Action {
	...
	public String execute(HttpServletRequest request,
		...
		int totalNum = webServiceDao.count();  // 文件总数
		...
		List<WebService> webServiceList = webServiceDao.getWebService(pageBean);
		Result result = new Result();
		result.setList(webServiceList);
