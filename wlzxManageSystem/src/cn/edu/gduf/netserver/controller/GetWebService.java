...
public class GetWebService extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		webService = webServiceDao.getWebServiceById(fileID);//查询用户当前的角色
		System.out.println(webService);
		JSONObject jsonObject = JSONObject.fromObject(webService);
